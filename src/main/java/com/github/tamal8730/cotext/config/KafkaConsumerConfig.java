...
public class KafkaConsumerConfig {
    ...
    public ConsumerFactory<String, KafkaMessageModel> consumerFactory() {
        ...
        return new DefaultKafkaConsumerFactory<>(props, new StringDeserializer(), new JsonDeserializer<>(KafkaMessageModel.class));
    }

    @Bean
    public KafkaListenerContainerFactory<ConcurrentMessageListenerContainer<String, KafkaMessageModel>> kafkaListenerContainerFactory() {
